...
//Banner
Route::get('/administrator/banner/read', ["as"=>"backend_banner_read","uses"=>"Backend\BannerController@read"]);
...
//Brand
Route::get('/administrator/brand/read', ["as"=>"backend_brand_read","uses"=>"Backend\BrandController@read"]);
...
//Category
Route::get('/administrator/category/read', ["as"=>"backend_category_read","uses"=>"Backend\CategoryController@read"]);
...
//Configuration
Route::get('/administrator/configuration/read', ["as"=>"backend_configuration_read","uses"=>"Backend\ConfigurationController@read"]);
...
//DisplayCategory
Route::get('/administrator/display-category/read', ["as"=>"backend_display_category_read","uses"=>"Backend\DisplayCategoryController@read"]);
...
//Gender
Route::get('/administrator/gender/read', ["as"=>"backend_gender_read","uses"=>"Backend\GenderController@read"]);
...
//Product
Route::get('/administrator/product/read', ["as"=>"backend_product_read","uses"=>"Backend\ProductController@read"]);
...
//ProductImage
Route::get('/administrator/product-image/read', ["as"=>"backend_product_image_read","uses"=>"Backend\ProductImageController@read"]);
...
//ProductSize
Route::get('/administrator/product-size/read', ["as"=>"backend_product_size_read","uses"=>"Backend\ProductSizeController@read"]);
...
//StoreController
Route::get('/administrator/store/read', ["as"=>"backend_store_read","uses"=>"Backend\StoreController@read"]);
