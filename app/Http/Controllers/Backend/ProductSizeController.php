...
class ProductSizeController extends BaseController
{
  ...
  public function create(){
		...
		$exists = ProductSize::where(['product_id'=>Input::get('product_id'),'size_id'=>Input::get('size_id')])->count();

		if($exists){
			$success = false;
			$message = "Size already exists, please use update existing instead of create!";
		}else{
			DB::beginTransaction();
